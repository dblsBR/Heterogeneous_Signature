...
const int m1 = 999;              // Number of nodes in the first group/class of nodes
const int m2 = v-m1;            // Number of nodes in the second group/class of nodes
const int M = 1;              // Number of MC replications
...
signature (group_1, group_2, g, m1, m2, v, V);

s3 = clock();

//    vector<double> R = survival_function (m1, m2);
//    s4 = clock();
