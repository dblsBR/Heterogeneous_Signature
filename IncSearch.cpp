...
void print_vector_bool (vector<bool> x, int size)
{
...
void signature (vector<int> group_1, vector<int> group_2, Graph g, int m1, int m2, int v, int V);
...
//
cout << endl;
cout << endl <<"Incremental Search Algorithm - Run-time Performance:" <<endl;
