...
const int M = 500;              // Number of MC replications
...
void verify_iteration (array<int, 5> l_star, MaxHeap* Heap);

void print_list_label(MaxHeap* Heap);

vector<int> sample_WO (vector<int> m, int sizeComb, int j);

void BO_survSig (vector<int> perm1, vector<int> perm2, Graph g, MaxHeap* Heap);

void survSig_estimation ();

void print_vector (vector<int> x, int size)
{
...
vector<double> survival_function (int m1, int m2);
...
void verify_iteration (array<int, 5> l_star, MaxHeap* Heap)
{
    cout << endl << "permanent labels: " <<endl;
//    for(int i=0; i < V; i++)
//    {
//        for (list<array<int, N>>::iterator lj=ndpoints[i].begin(); lj != ndpoints[i].end(); lj++)
//        {
          Heap->print_lable(l_star);
//        }
//    }
...
//double sum = 0.0;
//cout << "Number of non-dominated points: " <<endl;
//    for (int i=0; i < V; i++){
//        sum = sum + ndpoints[i].size();
//         cout << "ndpoints["<<i<<"] = "<<ndpoints[i].size() << endl;
//    }
//
}
...
//        cout << setprecision(4) << survSig[i][j] << " ";
    }
//    cout << endl;
   }
