...
const int m1 = 1499;              // Number of nodes in the first group/class of nodes
...
// Assigns the first m1 even nodes to the first class and the remaining m2 nodes to the second class
    ...
    ofstream myfile;
    net1 = net + "_IncSearch_M" + to_string(M) + "_m1_" + to_string(m1);
    net1 += "_signature.txt";
	myfile.open(net1);
...
//    s5 = clock();
    ...
    string net2;
    net2 = net + "_IncSearch_M" + to_string(M) + "_m1_" + to_string(m1);
    net2 += "_Run.txt";
    ...
    cout <<"IncSearch Algorithm - Run-time Performance:" <<endl;
    myfile2 <<"IncSearch Algorithm - Run-time Performance:" <<endl;
